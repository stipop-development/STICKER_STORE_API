...
아래 API 문서는 '스티커 스토어' 설치를 위한 문서입니다. 스티커 스토어가 아닌 일반 스티커 설치는 <a href="https://github.com/stipop-development/Stipop_Sticker_API" target="_blank">여기</a>서 확인할 수 있습니다.
...
v0.1은 스티커 스토어 개발을 위한 기본 기능/스티커를 테스트 해볼 수 있는 버전입니다. 세부 기능이 포함된 1.0 버전은 곧 공개 될 예저입니다.
